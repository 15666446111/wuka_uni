<template>
	<view>
		...
		<!-- 金额 -->
		<view :class="['contentss', show ? '' : 'contenthide']">
			<view class="title">
			...
			<view class="pay-money">
				<view>金额</view>
				<view class="moneyss">￥ <text>10000</text></view>
			</view>
			<view class="pay-way">
				<view>支付方式</view>
				<view class="pay-img"><image src="/static/pa.png"/>平安银行</view>
			</view>
			<view :class="['code', show ? '' : 'visible']">
				...
				<input  class="fgy-input" type="number" v-model="password" />
			</view>			
		</view>
		<!-- 键盘 -->
